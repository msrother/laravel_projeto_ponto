...

{
    ...
    protected $fillable = ['nome', 'email', 'cpf', 'cidade_id', 'cargo_id'];    //, 'cidade_id', 'cargo_id'

    public function updateFuncionario($id, $nome, $email, $cpf, $cidade_id, $cargo_id)   //, $cidade_id, $cargo_id
    {
